...
sp1 = Song_In_Playlist.create(playlist_id: p1, song_id: s1)
sp2 = Song_In_Playlist.create(playlist_id: p2, song_id: s2)
sp3 = Song_In_Playlist.create(playlist_id: p2, song_id: s3)
sp4 = Song_In_Playlist.create(playlist_id: p2, song_id: s4)
sp5 = Song_In_Playlist.create(playlist_id: p2, song_id: s5)
sp6 = Song_In_Playlist.create(playlist_id: p3, song_id: s6)
sp7 = Song_In_Playlist.create(playlist_id: p3, song_id: s7)
sp8 = Song_In_Playlist.create(playlist_id: p3, song_id: s8)
sp9 = Song_In_Playlist.create(playlist_id: p3, song_id: s9)
sp10 = Song_In_Playlist.create(playlist_id: p4, song_id: s10)
sp11 = Song_In_Playlist.create(playlist_id: p4, song_id: s11)
sp12 = Song_In_Playlist.create(playlist_id: p4, song_id: s12)
sp13 = Song_In_Playlist.create(playlist_id: p4, song_id: s13)
sp14 = Song_In_Playlist.create(playlist_id: p4, song_id: s14)
